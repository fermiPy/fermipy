...
RUN mkdir -p /home/ScienceTools \
    && curl -o /home/ScienceTools/ScienceTools-11-07-00-user.tar.gz ${SLAC_ST_URL}/11-07-00/ScienceTools-11-07-00-user.tar.gz \
    && cd /home/ScienceTools && tar xzf ScienceTools-11-07-00-user.tar.gz && rm ScienceTools-11-07-00-user.tar.gz
