...
RUN mkdir -p /home/ScienceTools \
    && curl -o /home/ScienceTools/ScienceTools-11-05-02-user.tar.gz ${SLAC_ST_URL}/11-05-02/ScienceTools-11-05-02-user.tar.gz \
    && cd /home/ScienceTools && tar xzf ScienceTools-11-05-02-user.tar.gz && rm ScienceTools-11-05-02-user.tar.gz
