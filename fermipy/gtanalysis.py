...
norm_parameters = {
    ...
    'PLSuperExpCutoff3': ['Prefactor'],
    'PLSuperExpCutoff4': ['Prefactor'],
    'ExpCutoff': ['Prefactor'],
...
shape_parameters = {
    ...
    'PLSuperExpCutoff3': ['IndexS', 'Expfactor2'],
    'PLSuperExpCutoff4': ['IndexS', 'ExpfactorS'],
...
index_parameters = {
    ...
    'PLSuperExpCutoff3': ['IndexS', 'Index2'],
    'PLSuperExpCutoff4': ['IndexS', 'Index2'],
    'ExpCutoff': ['Index1'],
    'FileFunction': [],
    'DMFitFunction': [],
    'Gaussian': [],
...
#        print(self.like.logLike.use_single_fixed_map())
    ...
    def _psf_app(self, overwrite=False, **kwargs):
        ...
        kw = dict(expcube=self.files['ltcube'],
                  ...
                  irfs = self.config['gtlike']['irfs'],
                  evtype = self.config['selection']['evtype'],
                  ra = self.roi.skydir.ra.value,
                  dec = self.roi.skydir.dec.value,
                  emin =  self.config['selection']['emin'],
                  emax =  self.config['selection']['emax'],
