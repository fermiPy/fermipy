...
sed_output = OrderedDict((
    ('loge_min', (None, 'Lower edges of SED energy bins (log10(E/MeV)).', np.ndarray, '`~numpy.ndarray`')),
    ('loge_max', (None, 'Upper edges of SED energy bins (log10(E/MeV)).', np.ndarray, '`~numpy.ndarray`')),
    ('loge_ctr', (None, 'Centers of SED energy bins (log10(E/MeV)).', np.ndarray, '`~numpy.ndarray`')),
    ('loge_ref', (None, 'Reference energies of SED energy bins (log10(E/MeV)).', np.ndarray, '`~numpy.ndarray`')),
    ('e_min', (None, 'Lower edges of SED energy bins (MeV).', np.ndarray, '`~numpy.ndarray`')),
    ('e_max', (None, 'Upper edges of SED energy bins (MeV).', np.ndarray, '`~numpy.ndarray`')),
    ('e_ctr', (None, 'Centers of SED energy bins (MeV).', np.ndarray, '`~numpy.ndarray`')),
    ('e_ref', (None, 'Reference energies of SED energy bins (MeV).', np.ndarray, '`~numpy.ndarray`')),
    ...
    ('ref_dnde', (None, 'Differential flux of the reference model evaluated at the bin center (%s)'%DIFF_FLUX_UNIT,  np.ndarray, '`~numpy.ndarray`')), 
    ('ref_dnde_e_min', (None, 'Differential flux of the reference model evaluated at the lower bin edge (%s)'%DIFF_FLUX_UNIT,  np.ndarray, '`~numpy.ndarray`')), 
    ('ref_dnde_e_max', (None, 'Differential flux of the reference model evaluated at the upper bin edge (%s)'%DIFF_FLUX_UNIT,  np.ndarray, '`~numpy.ndarray`')), 
    ('ref_e2dnde', (None, 'E^2 x the differential flux of the reference model evaluated at the bin center (%s)'%ENERGY_FLUX_UNIT,  np.ndarray, '`~numpy.ndarray`')), 
    ...
    ('dnde', (None, 'Differential flux in each bin (%s).'%DIFF_FLUX_UNIT,np.ndarray,'`~numpy.ndarray`')),
    ('e2dnde', (None, 'E^2 x the differential flux in each bin (%s).'%ENERGY_FLUX_UNIT,np.ndarray,'`~numpy.ndarray`')),
    ('dnde_err', (None, '1-sigma error on dnde evaluated from likelihood curvature.',np.ndarray,'`~numpy.ndarray`')),
    ('dnde_err_lo', (None, 'Lower 1-sigma error on dnde evaluated from the profile likelihood (MINOS errors).',np.ndarray,'`~numpy.ndarray`')),
    ('dnde_err_hi', (None, 'Upper 1-sigma error on dnde evaluated from the profile likelihood (MINOS errors).',np.ndarray,'`~numpy.ndarray`')),
    ('dnde_ul95', (None, '95% CL upper limit on dnde evaluated from the profile likelihood (MINOS errors).',np.ndarray,'`~numpy.ndarray`')),
    ('dnde_ul', (None, 'Upper limit on dnde evaluated from the profile likelihood using a CL = ``ul_confidence``.',np.ndarray,'`~numpy.ndarray`')),
    ('e2dnde_err', (None, '1-sigma error on e2dnde evaluated from likelihood curvature.',np.ndarray,'`~numpy.ndarray`')),
    ('e2dnde_err_lo', (None, 'Lower 1-sigma error on e2dnde evaluated from the profile likelihood (MINOS errors).',np.ndarray,'`~numpy.ndarray`')),
    ('e2dnde_err_hi', (None, 'Upper 1-sigma error on e2dnde evaluated from the profile likelihood (MINOS errors).',np.ndarray,'`~numpy.ndarray`')),
    ('e2dnde_ul95', (None, '95% CL upper limit on e2dnde evaluated from the profile likelihood (MINOS errors).',np.ndarray,'`~numpy.ndarray`')),
    ('e2dnde_ul', (None, 'Upper limit on e2dnde evaluated from the profile likelihood using a CL = ``ul_confidence``.',np.ndarray,'`~numpy.ndarray`')),
